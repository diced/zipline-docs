...
![no compression](/guides/compression-100.png 'No compression')

![compression](/guides/compression-20.png 'Compression at 20%')
...
![original name](/guides/original-name-1.png "The file's original name can be seen in the title, while the URL has the random name.")
