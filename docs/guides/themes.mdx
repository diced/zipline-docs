...
![themes primaryColor outlined](/guides/themes-primaryColor.png 'The button is using the primary color of the provided dark_blue theme.')

### `mainBackgroundColor`

This is the background color behind the content.

![themes mainBackgroundColor outlined](/guides/themes-mainBackgroundColor.png 'The areas outlined in red are the mainBackgroundColor')
...
![dashboard settings](/guides/themes-dashboard-system.png)

If you select anything other than "System", it will use the selected theme regardless of the system preference.
![dashboard settings](/guides/themes-dashboard-nosystem.png)
