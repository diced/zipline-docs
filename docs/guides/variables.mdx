...
| `{file.favorite}`     | [`boolean`](#boolean-modifiers) | If the file is favorited    |
...
| Modifier    | Description                 | Example                              |
| ----------- | --------------------------- | ------------------------------------ |
| `yesno`     | Yes/No                      | `true` -> `Yes`, `false` -> `No`     |
| `onoff`     | On/Off                      | `true` -> `On`, `false` -> `Off`     |
| `truefalse` | True/False                  | `true` -> `True`, `false` -> `False` |
| `string`    | Convert the value to string | `true` -> `true`, `false` -> `false` |

unknown -> `{unknown_bool_modifier({mod})}`
