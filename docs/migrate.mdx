...
![Manage Account](/img/migrate-1.png)

2. You will have to click "Yes" to confirm the export.

![Export Data](/img/migrate-2.png 'The modal shows what data is collected in the export file and asks for confirmation.')
...
![Download Data](/img/migrate-3.png)
...
![Export Data Viewer](/img/migrate-7.png)
...
![Import Settings](/img/migrate-8.png)
...
![Confirm Import](/img/migrate-9.png)
...
![Import Success](/img/migrate-10.png)
