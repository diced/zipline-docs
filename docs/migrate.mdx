...
<Alert type='info'>
  ...
  run `ALTER DATABASE template1 REFRESH COLLATION VERSION` in the postgres CLI to rebuild all of the objects in the template database using the new version, and you should be able to proceed.
</Alert>
