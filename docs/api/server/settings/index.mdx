...
Returns an object containing server settings and tampered settings. Tampered settings are settings that have been modified and overridden by environment variables.

| Property   | Type                          | Description                                                                                                                                                      |
| ---------- | ----------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `settings` | [see below](#settings-object) | Settings object, refer to [`schema.prisma`](https://github.com/diced/zipline/blob/trunk/prisma/schema.prisma#L11) for the full schema (Look for `model Zipline`) |
| `tampered` | `string[]`                    | Array of setting names that have been overridden by environment variables.                                                                                       |
