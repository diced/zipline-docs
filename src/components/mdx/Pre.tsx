...
export default function Pre({
  ...
  return (
    <>
      {filename && (
        <div className='flex items-center justify-between bg-white shadow-md dark:bg-gray-900 border-b-0 border border-gray-100 dark:border-gray-800 rounded-t-md px-4 py-1'>
