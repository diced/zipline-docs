...
export default function HomeCard({
  ...
  return (
    <div className='relative w-full rounded-md p-0 hover:p-0.5 flex-col flex-grow transition-all hover:-translate-y-1 hover:shadow-2xl'>
      <div className='absolute inset-0 rounded-md p-[2px] bg-gradient-to-r from-blue-500 via-purple-500 to-blue-500 [background-size:200%_200%] [animation:gradient-spin_3s_linear_infinite]'></div>
