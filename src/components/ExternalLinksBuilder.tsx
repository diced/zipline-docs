...
export default function ExternalLinksBuilder() {
  ...
  const handleAdd = () => {
    ...
    try {
      ...
      console.log('invalid link ' + newLink.link);
      return;
    }
  ...
  return (
    <div>
      <div className='flex gap-4'>
        ...
        />
        <button
          className='bg-blue-400 rounded-md p-2 px-4 transition-all hover:bg-blue-500 ease-in-out disabled:bg-gray-300 disabled:dark:bg-gray-600 disabled:text-gray-100 disabled:dark:text-gray-300'
          onClick={handleAdd}
