...
<Callout type='warning'>
  Never share this token with anyone, this token has full access to your account and if you are a super-admin,
  it can be used to change settings.
</Callout>
...
To authenticate with cookies, you need to first set a [POST /api/auth/login](/docs/api/api/auth/login/post).
