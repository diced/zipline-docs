...
Before building Zipline, create a `.env` file and configure a database. You can use a running PostgreSQL server, as below, or a local [PGlite directory](/docs/config/core#pglite).
