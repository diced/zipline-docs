...
This guide uses PostgreSQL. To use an embedded database instead, see [PGlite configuration](/docs/config/core#pglite), including the required persistent volume.
...
Before updating, read the [database upgrade notes](/docs/guides/releases#database-upgrades).
