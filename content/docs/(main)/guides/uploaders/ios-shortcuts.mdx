---
title: 'iOS: Shortcuts'
description: Use the Zipline shortcut on iOS to upload and shorten links from your device
---

## Install Shortcut

To install the shortcut on your iOS device, head over to the [Zipline iCloud](https://www.icloud.com/shortcuts/f297e446fd1346beaa52636a865349eb) page and tap "**Get Shortcut**". Your shortcuts app will then open and you will be prompted to set up the shortcut.
