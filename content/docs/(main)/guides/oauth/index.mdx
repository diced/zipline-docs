...
<Callout>
  There are no plans to support other OAuth providers. The four that are
  currently supported were chosen as they are commonly used, and OIDC support
  allows for various different self-hosted providers to be used as well. If you
  have a specific provider you would like to see supported, please open an issue
