...
<Cards>
  <Card href='/docs/guides/cli/read-config' title='📖 Read Config'>
    Output the configuration as JSON, exactly how Zipline sees it
  </Card>
  <Card href='/docs/guides/cli/list-users' title='👥 List Users'>
    List all users
  </Card>
  <Card href='/docs/guides/cli/set-user' title='✏️ Set User'>
    Set a property in a user, like their password
  </Card>
  <Card href='/docs/guides/cli/import-dir' title='📩 Import Directory'>
