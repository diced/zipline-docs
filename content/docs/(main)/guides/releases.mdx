...
<Callout type='info'>
  Note that it must be the short version of the commit hash, which is the first
  7 characters of the full commit hash. You can find this in the commit history
  on GitHub.
</Callout>
