---
title: Datasource
description: This page will document the configuration options available for the datasource
---
...
<Callout type='warn'>
  If you are using a provider other than AWS S3, you may need to set this option
  to `true`. If you notice errors when starting Zipline, or when
  uploading/getting files, try setting this option to `true`. If you are unsure
  whether or not your provider requires this, check their API documentation or
