...
Zipline requires `CORE_SECRET` and a database connection: either `DATABASE_URL` or all five [PostgreSQL connection variables](/docs/config/core#database_url). The rest are optional and have default values.
