...
description: How to report security vulnerabilities and the supported versions of Zipline.
icon: LockKeyhole
---
...
On February 24, 2024, we [announced](https://github.com/diced/zipline/discussions/723) that Zipline v3 will reach its end of life (EOL) in June 2025. After this date, we will no longer provide updates, security patches, or resolve issues for Zipline v3. We recommend upgrading to v4 as soon as possible within this timeframe.
